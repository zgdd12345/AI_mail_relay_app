...
class ArxivPaper:
    ...
    research_field: str = ""  # Hierarchical research field (e.g., "计算机视觉 → 图像分割 → 道路分割")
    # Database-related fields
    db_id: int | None = None  # Database primary key (set when loaded from DB)
    published_date: date | None = None  # arXiv publication date
