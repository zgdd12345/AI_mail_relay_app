...
```
按提示输入运行时间（默认：08:00，每天早上获取前一日论文）
...
logs/
├── cron.log                      # Cron 总日志
├── run_2025-10-31_08-00-00.log  # 单次运行日志
...
0 8 * * *      # 每天 08:00
30 14 * * *    # 每天 14:30
0 8,14,18 * * *  # 每天 08:00, 14:00, 18:00
0 */6 * * *    # 每 6 小时
0 8 * * 1-5    # 工作日 08:00
```
...
- Cron 时间 = 北京时间
- 默认 08:00 获取前一日论文，如需靠近公告发布时间可自定义
...
5. **时间设置**：默认 08:00，如需其他时间可重新运行 `setup_cron.sh`
